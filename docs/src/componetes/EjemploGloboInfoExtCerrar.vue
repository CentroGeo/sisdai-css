<template>
  <div class="contenedor-globo-info-ext">
    ...
    <div class="cuerpo-globo-info">
      ...
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio omnis, quas sequi mollitia dolorem enim molestiae tempore temporibus fugiat esse sed, voluptatem expedita porro cupiditate minima unde quaerat corporis. Nihil.
        <br />
