    ...
    <div class="flex flex-contenido-centrado m-y-5">
      <div class="columna-6">
        <a class="tarjeta tarjeta-hipervinculo-externo" href="https://sisdai.conahcyt.mx/" target="_blank" rel="noopener noreferrer">
          ...
          <div class="tarjeta-degradado">
            <div class="tarjeta-cuerpo">
              <p>Título portada secundaria</p>
              <p class="h2 borde-b">Subtítulo <span class="pictograma-flecha-arriba-derecha"></span></p>
              <p class="h5">Título portada primaria</p>
            </div>
          </div>
        </a>
      </div>
      <div class="columna-6">
        <a class="tarjeta tarjeta-hipervinculo-externo" href="https://sisdai.conahcyt.mx/" target="_blank" rel="noopener noreferrer">
          ...
          <div class="tarjeta-degradado">
            <div class="tarjeta-cuerpo">
              <p>Título</p>
              <p class="h1">Título portada primaria <span class="pictograma-flecha-arriba-derecha"></span></p>
            </div>
          </div>
        </a>
      </div>
