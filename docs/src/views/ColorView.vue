<template>
  ...
  <div>
    ...
    <div class="grid">
      <div class="columna-2 m-y-1 borde-informativo-2  borde borde-grosor-3 borde-redondeado-8"></div>
      <div class="columna-2">
        <p>.borde-informativo-2</p>
      </div>
      <div class="columna-2 m-y-1 borde-error-2  borde borde-grosor-3 borde-redondeado-8"></div>
      <div class="columna-2">
        <p>.borde-error-2</p>
      </div>
      <div class="columna-2 m-y-1 borde-advertencia-2  borde borde-grosor-3 borde-redondeado-8"></div>
      <div class="columna-2">
        <p>.borde-advertencia-2</p>
      </div>
      <div class="columna-2 m-y-1 borde-correcto-2  borde borde-grosor-3 borde-redondeado-8"></div>
      <div class="columna-2">
