          ...
          <ul class="nav-menu">
            ...
            <li class="nav-contenedor-submenu">
              ...
              <ul class="nav-submenu" :class="{ 'abierto': showSubmenu == 'componentes' }">
                ...
                <li><RouterLink class="nav-hipervinculo" to="/componentes/control-deslizante-contenido">Control Deslizante Contenido <span class="etiqueta">pre</span> </RouterLink></li>
